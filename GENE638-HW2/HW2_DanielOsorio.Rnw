...
\begin{equation}
\begin{split}
A &= \left[\begin{array}{cc;{2pt/2pt}c}1 & 0 &1 \\\hdashline[2pt/2pt] 0 & 2 & 2 \\ 1 & 2 & 3\end{array}\right]\\
A_{\left[\begin{array}{c}12\\22\end{array}\right]}&= \left[\begin{array}{cc}1&0\\0&1\\2&1\end{array}\right]\left[\begin{array}{c}1\\1\end{array}\right]\\
A_{\left[\begin{array}{c}12\\22\end{array}\right]}&= \left[\begin{array}{c}(1 \times 1 + 0 \times 1)\end{array}\right]
\end{split}
\end{equation}
%\multirow{2}{*}{}
